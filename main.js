                ...
                for (var i = 0; i < navigationAnchors.length; i++) {
                    ...
                    if (navigationAnchors.length == 6) {
                        ...
                        navigationAnchors[4].addEventListener("click", function() {
                            ...
                            typeText("<div style='margin-bottom: 2vw;'><h3>AI Agent playing Chrome's Dino game</h3><br/><span style='margin-left: 5vw'>The goal of this project is to train an AI agent to play Google’s offline Dino game using Reinforcement Learning. Used Q-Learning to process the screen of the game as input and train the CNN. The final trained CNN was able to achieve a high score of more than 15000.</span></div><div style='margin-bottom: 2vw;'><h3>Photo Puzzle</h3><br/><span style='margin-left: 5vw'>An iOS gaming application to transform multiple scrambled images into a meaningful big picture. The score is based on factors: the total amount of time taken to arrange the picture and the number of moves made.</span></div><div style='margin-bottom: 2vw;'><h3>Face Recognition using MATLAB</h3><br/><span style='margin-left: 5vw'>This application uses Histograms of Oriented Gradients (HOG) features for face recognition and obtains an accuracy of 82%. It provides feature to add a person's face by capturing input images via webcam and storing features of the input, then these features are used for the recognition process.</span></div><div style='margin-bottom: 2vw;'><h3>Powered by Science Mobile Application</h3><br/><span style='margin-left: 5vw'>A useful classroom tool to support instructions in science, math and reading comprehension. Worked on Unity to convert a web-based application into a mobile gaming application compatible with both iOS and Android platforms. Worked on its performance by removing redundant UI renderings.</span></div>",
                            15, 30, this);
                        });
                        ...
                        navigationAnchors[5].addEventListener("click", function() {
                            ...
                            typeText("<ul><li>Award of Recognition for substantial contribution to projects from Plantronics.</li><li>Was listed in school's Hall of Fame for performing well in coursework.</li><li>Won first prize in technical competitions like C- Debugging and Web Designs continuously for three years during Bachelor's.</li></ul>",
                            15, 100, this);
                        });
                    }
                }
